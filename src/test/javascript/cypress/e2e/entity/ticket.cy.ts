...
describe('Ticket e2e test', () => {
  ...
  describe('new Ticket page', () => {
    ...
    it('should create an instance of Ticket', () => {
      ...
      cy.get(`[data-cy="dueDate"]`).type('2022-08-30').blur().should('have.value', '2022-08-30');

      cy.get(`[data-cy="date"]`).type('2022-08-31T14:18').blur().should('have.value', '2022-08-31T14:18');
